...
// TODO: policy.
router.put('/:crowdfunding_id/comments', authenticate, function(req, res) {
    let senderId = req.user.id;
    let message = req.body.message;
    let crowdfundingId = req.params.crowdfunding_id;
    let inReplyTo = req.body.hasOwnProperty('in_reply_to') ? req.body.in_reply_to : null;
    let query =
        `INSERT INTO comment (sender_id, message, crowdfunding_id, date_posted, in_reply_to)
        VALUES ($(sender_id), $(message), $(crowdfunding_id), NOW(), $(in_reply_to));`;
 ...
 */
// TODO: policy.
router.put('/comments/:comment_id', authenticate, function(req, res) {
    let senderId = req.user.id;
 ...
 */
// TODO: policy.
router.delete('/comments/:comment_id', authenticate, function(req, res) {
    let senderId = req.user.id;
    let commentId = req.params.comment_id;
    let query =
        `DELETE FROM comment
