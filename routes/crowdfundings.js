...
router.post('/', authenticate, function(req, res) {
    ...
    let query =
        `INSERT INTO crowdfunding (title, description, category, location, latitude, longitude, date_created, date_finished, creator_id)
        VALUES ($(title), $(description), $(category), $(location), $(latitude), $(longitude), NOW(), NOW() + INTERVAL '$(time_interval) weeks', $(creator_id))
...
router.get('/:crowdfunding_id', function(req, res) {
    ...
    let query =
        `SELECT title, description, category, location, crowdfunding.latitude, crowdfunding.longitude, recruiting_balance, collected_balance, date_created, date_finished, status, creator_id, users.full_name as creator_name, users.id as creator_id,
