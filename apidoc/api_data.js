define({ "api": [
        ...
        "RequestParam": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Associations id.</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Successfully deleted association.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            ...
            "description": "<p>Could't delete the Association.</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "./routes/associations.js",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Successfully updated association.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            "group": "Error 500",
            "optional": false,
            "field": "policy.editnternalServerError",
            "description": "<p>Could't update the association.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/crowdfundings/:crowdfunding_id/rating/:user_id",
    "title": "Get crowdfunding rating for a user",
    "name": "GetCrowdfundingRatingUser",
    "group": "Crowdfunding",
    "parameter": {
      "fields": {
        "RequestParam": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "rating",
            "description": "<p>Crowdfunding rating.</p>"
          }
        ]
      }
    },
        ...
        "RequestUser": [
          {
            ...
            "optional": false,
            "field": "user_id",
            "description": "<p>Id of user that wants to close his poll.</p>"
          }
        ],
        "RequestBody": [
          {
            ...
            "optional": false,
            "field": "closed",
            "description": "<p>Poll closed state.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            ...
            "optional": false,
            "field": "InternalServerError",
            "description": "<p>Couldn't change poll state.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "RequestBody": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "free_text",
            "description": "<p>Poll answers are free text.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            ...
            "optional": false,
            "field": "InternalServerError",
            "description": "<p>Couldn't create a poll.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/polls/:poll_id/answers",
    "title": "Create poll asnwer",
    "name": "CreatePollAnswer",
    "group": "Poll",
    "permission": [
      {
        "name": "authenticated user"
        ...
        "RequestUser": [
          {
            ...
            "optional": false,
            "field": "user_id",
            "description": "<p>Id of user that answered.</p>"
          }
        ],
        "RequestBody": [
          {
        ...
        "Success 201": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Sucessfully added poll answer.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            ...
            "optional": false,
            "field": "InternalServerError",
            "description": "<p>Error adding answer.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "free_text",
            "description": "<p>Free text poll status.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "options",
            "description": "<p>Poll possible answers.</p>"
          },
          {
            "group": "Success 200",
            "type": "Integer",
            "optional": false,
            "field": "id_creator",
            "description": "<p>Id of poll creator.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            ...
            "optional": false,
            "field": "InternalServerError",
            "description": "<p>Couldn't get polls.</p>"
          }
        ]
      }
    },
        ...
        "Error 500": [
          {
            ...
            "optional": false,
            "field": "InternalServerError",
            "description": "<p>Could't get the poll.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "answer",
            "description": "<p>Answer of the user.</p>"
          }
        ]
      }
    },
